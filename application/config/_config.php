...
return [
    ...
    'root_namespace'         => [],
    // 扩展配置文件
    'extra_config_list'      => ['database', 'route', 'validate', 'wechat'],
    // 扩展函数文件
    ...
    //推流地址配置
    'ALY_SERVER'=>'rtmp://video-center.alivecdn.com',
    'ALY_APP_NAME'=>'/bobo/',
    'ALY_SERVER_PUSH_URL'=>'www.yimwing.com',//阿里云推流地址
