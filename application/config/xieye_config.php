...
return (file_get_contents( dirname(__FILE__) . '/xieye_id.php') == '88' ) ? [
    // +----------------------------------------------------------------------
    // | 应用设置
    // +----------------------------------------------------------------------
...
[
    ...
    // 异常页面的模板文件
        'exception_tmpl'         => ROOT_PATH . 'application' . DS . '404.tpl',
    ...
    'show_error_msg' => false,
    // 异常处理handle类 留空使用 \think\exception\Handle
    'exception_handle' => '\\app\\systemmanage\\controller\\Err',
