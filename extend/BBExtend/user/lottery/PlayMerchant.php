...
class PlayMerchant
{
    ...
    public function  __construct($uid=0) 
    {
       ...
       // 检查用户
        ...
        // 设置次数帮助对象。
        $this->play_count_obj = new PlayCountMerchant($uid);
    }
    ...
    public function get_lottery_point()
    {
        ...
        $result = DbSelect::fetchAll($db, $sql,[ TableType::lt_roulette__type_shanghu ]);
    ...
    private function complete_lottery($lt_id)
    {
        ...
        $db->insert("lt_draw_log", [
            ...
            'type'         => TableType::lt_roulette__type_shanghu,
        ]);
